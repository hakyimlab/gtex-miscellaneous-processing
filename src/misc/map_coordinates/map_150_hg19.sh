...
-db_snp_file /gpfs/data/im-lab/nas40t2/abarbeira/data/ucsc-hg/snp150_hg19.txt.gz \
...
-output results/map_snp150_hg19.txt.gz \
-discard results/unmatched_snp150_hg19.txt.gz