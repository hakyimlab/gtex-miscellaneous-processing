...
-liftover /gpfs/data/im-lab/nas40t2/abarbeira/data/liftover/hg18ToHg38.over.chain.gz \
-db_snp_file /gpfs/data/im-lab/nas40t2/abarbeira/data/ucsc-hg/snp130_hg18.txt.gz \
...
-output results/map_snp130_hg18.txt.gz \
-discard results/unmatched_snp130_hg18.txt.gz