...
--prediction_output new_predixcan/en_geuv_v6/Adipose_Subcutaneous__predict.txt \
--prediction_summary_output new_predixcan/en_geuv_v6/Adipose_Subcutaneous__summary.txt \
--throw
