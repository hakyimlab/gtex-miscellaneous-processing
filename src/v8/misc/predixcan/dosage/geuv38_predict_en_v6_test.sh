...
--text_genotypes /gpfs/data/im-lab/nas40t2/abarbeira/projects/gtex_v8/data/geuvadis_eur_hg38/dosage/chr1.txt.gz \
--text_sample_ids  /gpfs/data/im-lab/nas40t2/abarbeira/projects/gtex_v8/data/geuvadis_eur_hg38/dosage/samples.txt \
--prediction_output en_geuv_v6_test/Adipose_Subcutaneous__predict.txt \
--prediction_summary_output en_geuv_v6_test/Adipose_Subcutaneous__summary.txt \
--capture kk/capture_new.txt.gz \
--only_entries ENSG00000131795.8 \
--throw
