...
--prediction_output new_predixcan/en_geuv_v6_h5/Adipose_Subcutaneous__predict.h5 HDF5 \
--prediction_summary_output new_predixcan/en_geuv_v6_h5/Adipose_Subcutaneous__summary.txt \
--throw
