...
--vcf_genotypes /scratch/abarbeira3/data/1000G_hg37_geuv_eur/chr22.txt.gz \
--vcf_mode genotyped \
--liftover /gpfs/data/im-lab/nas40t2/abarbeira/data/liftover/hg19ToHg38.over.chain.gz \
--on_the_fly_mapping METADATA "chr{}_{}_{}_{}_b38" \
--prediction_output mashr_capture/new_p_Whole_Blood__predict.txt \
--prediction_summary_output mashr_capture/new_p_Whole_Blood__summary.txt \
--capture mashr_capture/capture_new_p.txt.gz \
--only_entries  ENSG00000075218.18 \
--verbosity 9 \
--throw
