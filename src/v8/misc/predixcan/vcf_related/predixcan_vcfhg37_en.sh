...
--vcf_genotypes /scratch/abarbeira3/data/1000G_hg37/ALL.chr*.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz \
--vcf_mode genotyped \
--prediction_output vcfhg37_en/Whole_Blood__predict.txt \
--prediction_summary_output vcfhg37_en/Whole_Blood__summary.txt \
--verbosity 9 \
--throw
