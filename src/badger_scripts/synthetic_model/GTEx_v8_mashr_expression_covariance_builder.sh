#!/bin/bash
#PBS -N gtex_v8_meta_covariance_expressionlicing_mashr
#PBS -S /bin/bash
#PBS -l walltime=24:00:00
#PBS -l mem=64gb
#PBS -l nodes=1:ppn=1
#PBS -o logs_mc_mashr/${PBS_JOBNAME}.o${PBS_JOBID}.log
#PBS -e logs_mc_mashr/${PBS_JOBNAME}.e${PBS_JOBID}.err
...
-model_db_folder /gpfs/data/im-lab/nas40t2/abarbeira/projects/gtex_v8/models_v1/eqtl/mashr \
-model_db_file_pattern "mashr_(.*).db" \
...
-output results/gtex_v8_expression_mashr_snp_covariance.txt.gz \
-parsimony 7