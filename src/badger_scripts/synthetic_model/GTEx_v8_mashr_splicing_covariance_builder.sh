#!/bin/bash
#PBS -N gtex_v8_meta_covariance_splicing_mashr
#PBS -S /bin/bash
...
-model_db_folder /gpfs/data/im-lab/nas40t2/abarbeira/projects/gtex_v8/models_v1/sqtl/mashr \
...
-output results/gtex_v8_splicing_mashr_snp_covariance.txt.gz \
-parsimony 7