...
-jobs_folder /scratch/abarbeira3/v8_process/model_training/eqtl/utmost_as_chr1/jobs \
-logs_folder /scratch/abarbeira3/v8_process/model_training/eqtl/utmost_as_chr1/logs \
