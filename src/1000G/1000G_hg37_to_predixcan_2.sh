...
SAMPLES=/gpfs/data/im-lab/nas40t2/abarbeira/data/1000G/selected_hg37_eur_id.txt
F="/scratch/abarbeira3/data/1000G_hg37_eur_dosage"
OUTPUT=$F/chr${PBS_ARRAYID}.txt.gz
[ -d $F ] || mkdir -p $F
