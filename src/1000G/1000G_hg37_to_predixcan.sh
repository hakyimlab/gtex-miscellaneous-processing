...
OUTPUT=/scratch/abarbeira3/data/1000G_hg37_dosage/chr${PBS_ARRAYID}.txt.gz
[ -d /scratch/abarbeira3/data/1000G_hg37_dosage ] || mkdir -p /scratch/abarbeira3/data/1000G_hg37_dosage
